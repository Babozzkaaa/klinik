        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="text-gray-500">Edit Role: {{ $role->name }}</span>
                </div>
            </li>
        </ol>
    </nav>
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" required
                            ...
                            value="{{ old('name', $role->name) }}" placeholder="Contoh: Manager, Staff, etc.">
                        @error('name')
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.section-select-all').forEach(selectAllCheckbox => {
        updateSectionSelectAllState(selectAllCheckbox);
    ...
    function updateSectionSelectAllState(selectAllCheckbox) {
